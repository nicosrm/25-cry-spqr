...
\begin{frame}{SPQR $\blacktriangleright$ Bandbreiten Limitierung \cite{auerbachHowCompareBandwidth2025, connellSignalProtocolPostQuantum2025,dodisTripleRatchetBandwidth2025}}
    \begin{itemize}
...
\begin{frame}{SPQR $\blacktriangleright$ Erasure Codes \cite{dodisTripleRatchetBandwidth2025, connellSignalProtocolPostQuantum2025,rolfeschmidtDesigningPostQuantumRatchet2025}}
    \vspace*{0.2cm}
    \begin{figure}
...
\begin{frame}{SPQR $\blacktriangleright$ ML-KEM \cite{connellSignalProtocolPostQuantum2025,rolfeschmidtDesigningPostQuantumRatchet2025}}
    \begin{columns}
...
\begin{frame}{SPQR $\blacktriangleright$ ML-KEM Braid \cite{connellSignalProtocolPostQuantum2025,rolfeschmidtDesigningPostQuantumRatchet2025}}
    \only{
        \begin{figure}
