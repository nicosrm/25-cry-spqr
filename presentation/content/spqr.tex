...
\begin{frame}{SPQR $\blacktriangleright$ Forward Secrecy und Post-Compromise Security}
    \begin{itemize}
...
\begin{frame}{SPQR $\blacktriangleright$ Bandbreiten Limitierung}
    \begin{itemize}
...
\begin{frame}{SPQR $\blacktriangleright$ Erasure Codes}
    \begin{itemize}
...
\begin{frame}{SPQR $\blacktriangleright$ Kapazität}
% Grafiken
\end{frame}

\begin{frame}{SPQR $\blacktriangleright$ Sparse Post Quantum Ratchet}
    \begin{itemize}
        \item ML-KEM
        \begin{itemize}
            \item ...
