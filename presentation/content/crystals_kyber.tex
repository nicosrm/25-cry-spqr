...
% TODO Quelle WIkipedia https://en.wikipedia.org/wiki/Key_encapsulation_mechanism einfügen für Bilder
\begin{frame}{CRYSTALS-Kyber}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                \item Key Encapsulation Mechanism (KEM)
                \item Empfehlung: hybrider Einsatz mit Prä-Quanten-Verfahren (z.\,B. ECC)
        ...
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[scale=0.15]{assets/PublicKeyEncryption.png}
            \vspace{0.5em}
            \includegraphics[scale=0.15]{assets/KEMSchema.png}
        \end{column}
    \end{columns}
\end{frame}
...
% TODO: Zeile für Mini-Beispiel einfügen
